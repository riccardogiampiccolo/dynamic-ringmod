function y = FastWrightOmega(x, apprLevel)

% Function written by R. Giampiccolo based on the method presented in:
%
% S. D Angelo, L. Gabrielli, and L. Turchet, "Fast Approximation of the 
% Lambert W Function for Virtual Analog Modelling", in Proc. 22nd Intl.
% Conf. Digital Audio Effects (DAFx-19), Birmingham, UK, September
% 2019.
